...
const List<_WorkspaceOption> _availableWorkspaces = [
  _WorkspaceOption(
    id: 'farm',
    title: 'Farm',
    subtitle: 'Manage crops, livestock, and farm operations',
    icon: Icons.agriculture_outlined,
  ),
  _WorkspaceOption(
    id: 'business',
    title: 'Business',
    subtitle: 'Manage enterprise, sales, and business operations',
    icon: Icons.business_outlined,
  ),
  _WorkspaceOption(
    id: 'transport',
    title: 'Transport',
    subtitle: 'Manage logistics, fleet, and delivery operations',
    icon: Icons.local_shipping_outlined,
  ),
  _WorkspaceOption(
    id: 'warehouse',
    title: 'Warehouse',
    subtitle: 'Manage inventory, storage, and distribution',
    icon: Icons.inventory_2_outlined,
  ),
  _WorkspaceOption(
    id: 'cooperative',
    title: 'Cooperative',
    subtitle: 'Manage group activities, collective sales, and member records',
