/// ============================================================
/// AUTH GUARD — Protects actions behind authentication
/// ============================================================
///
/// 🧠 LOCATION CONTEXT:
///   features/guest/ = visitor experience layer
///
/// ✅ Responsibilities:
///   - Check if current user is authenticated
///   - Show sign-in prompt for protected actions
///   - Centralized permission check for unauthenticated users
///
/// ❌ Does NOT:
...
/// Shows a sign-in prompt dialog when an unauthenticated visitor
/// attempts a protected action.
///
/// Returns:
///   - true: user can proceed (already authenticated, or dismissed prompt)
///   - false: user chose 'sign_in' or 'create_account' — should navigate away
///
...
Future<bool> showProtectedActionPrompt(
  ...
  if (isAuthenticated) return true; // Already authenticated, proceed
  ...
  // 'dismiss' or dialog dismissed → return true (proceed browsing)
  return true;
}
