...
import '../../../workspace/application/current_workspace_contexts_provider.dart';
...
class _ContextSelector extends ConsumerWidget {
  ...
  Future<void> _resolveAndActivateContext(
    ...
    // No second persistence RPC here. For an already-onboarded switch the
    // authoritative active context is `core.entity_context_sessions`, set by
    // `users.activate_workspace_context` above and re-read/validated before
    // this point. The workspace list/default is a separate onboarding/profile
    // concern and is not touched by ordinary switching.
